...
result_fpath = pathlib.Path("target_model/deepcorr/deepcorr300/Gbase/Gtest_index300_result.p")
output_filename = "./target_model/deepcorr/deepcorr300/results/Groc_curvelog.png"
