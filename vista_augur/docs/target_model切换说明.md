...
第二工作点现在已经不再保留 stub target model。`vista_augur/second_workpoint` 里的目标反馈模块只做一件事：
...
- `vista_augur/configs/second_workpoint_deepcorr300_torch_real_smoke.json`

### DeepCoFFEA smoke

配置文件：

- `vista_augur/configs/second_workpoint_deepcoffea_real_smoke.json`
