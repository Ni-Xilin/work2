...
adv_samples_fpath = pathlib.Path("baseline/PGD/PGDdeepcorr_advsamples_time0.1290_size0.0650.p")
...
all_outputs = []
all_labels = []
result_fpath = pathlib.Path("baseline/PGD/deepcorr/PGDtest_index300_result.p")
if False:
