...
def main():
    ...
    adv_samples_fpath = pathlib.Path("baseline/PGD/mdeepcorr/PGDmdeepcorr_advsamples_time0.1337_size0.0271.p")
    ...
    output_filename = f"PGDmdeepcorr_threshDC100_{threshold_dc100:.4f}.p"
    result_fpath = pathlib.Path("baseline/PGD/mdeepcorr") / output_filename
    results_to_save = {
