...
def main():
    ...
    adv_samples_fpath = pathlib.Path("baseline/I_FGSM/mdeepcorr/IFGSMmdeepcorr_advsamples_time0.1329_size0.0591.p")
    ...
    output_filename = f"IFGSMmdeepcorr_threshDC100_{threshold_dc100:.4f}.p"
    result_fpath = pathlib.Path("baseline/I_FGSM/mdeepcorr") / output_filename
    results_to_save = {
