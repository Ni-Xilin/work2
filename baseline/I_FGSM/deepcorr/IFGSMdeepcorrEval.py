...
adv_samples_fpath = pathlib.Path("baseline/I_FGSM/deepcorr/IFGSMdeepcorr_advsamples_time0.1323_size0.0705.p")
...
all_outputs = []
all_labels = []
result_fpath = pathlib.Path("baseline/I_FGSM/deepcorr/IFGSMtest_index300_result.p")
if False:
