...
def main():
    ...
    adv_samples_fpath = pathlib.Path("baseline/CW/mdeepcorr/CWmdeepcorr_advsamples_time0.1128_size0.1161.p")
    ...
    output_filename = f"CWmdeepcorr_threshDC100_{threshold_dc100:.4f}.p"
    result_fpath = pathlib.Path("baseline/CW/mdeepcorr") / output_filename
    results_to_save = {
