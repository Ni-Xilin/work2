...
if __name__ == '__main__':
    ...
    # Paths
    parser.add_argument("--model_path", type=str, default="target_model/deepcorr/deepcorr300/tor_199_epoch23_acc0.82dict.pth", help="Path to the pre-trained DeepCorr model.")
    ...
    parser.add_argument("--index_folder", type=str, default="target_model/deepcorr/deepcorr300/", help="Path to the folder containing test_index300.pickle.")
