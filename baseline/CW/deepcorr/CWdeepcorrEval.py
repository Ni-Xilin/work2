...
adv_samples_fpath = pathlib.Path("baseline/CW/CWdeepcorr_advsamples_time0.0969_size0.1325.p")
...
all_outputs = []
all_labels = []
result_fpath = pathlib.Path("baseline/CW/deepcorr/CWtest_index300_result.p")
if False:
